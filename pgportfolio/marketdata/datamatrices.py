...
class DataMatrices:
    def __init__(self, start, end, period=86400, batch_size=50, volume_average_days=30, buffer_bias_ratio=0,
    ...
    def __pack_samples(self, indexs):
        ...
        last_w = self.__PVM.values[indexs-1, :]  #（batch， asset）  
        def setw(w):
    ...
    def get_submatrix(self, ind): 
        temp = self.__global_data.values[:, :, ind:ind+self._window_size+1] 
        return temp
