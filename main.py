...
def main():
    ...
    if options.mode == "train":
        ...
        if not options.algo:
            pgportfolio.autotrain.training.train_all(int(options.processes), options.device)  # train all agents
        else:
        ...
        config = preprocess_config(config)   # preprocess the configuration
